...
This for is a modification of the original cap.js to make the standalone project work with postgresql dbs. Configuration is identical, so refer to the original docs below.
